...
CREATE TABLE IF NOT EXISTS User(ID INT NOT NULL AUTO_INCREMENT,EmailAddress VARCHAR(255) NOT NULL,Password VARBINARY(255) NOT NULL,Type VARCHAR(255) NULL DEFAULT NULL,FullName VARCHAR(255) NULL DEFAULT NULL,AddressId INT,PhoneNumber VARCHAR(255) NULL DEFAULT NULL,PRIMARY KEY ( ID ),CONSTRAINT FK_AddressId FOREIGN KEY (AddressId) REFERENCES Address(ID));
