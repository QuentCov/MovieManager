...
CREATE TABLE IF NOT EXISTS MovieShowing(ID INT NOT NULL AUTO_INCREMENT,MovieId INT,ShowroomId INT,StartTime VARCHAR(255) NULL DEFAULT NULL,EndTime VARCHAR(255) NULL DEFAULT NULL,NumTicketsSold INT(3) NULL DEFAULT NULL,Cost DECIMAL(15,2) NULL DEFAULT NULL,PRIMARY KEY ( ID ),CONSTRAINT FK_MovieInShowingId FOREIGN KEY (MovieId) REFERENCES Movie(ID),CONSTRAINT FK_ShowroomId FOREIGN KEY (ShowroomId) REFERENCES Showroom(ID));
